...
class BuildDollyRig(bpy.types.Operator):
    ...
    bl_label = "Build Advanced Dolly Camera Rig"
...
class BuildCraneRig(bpy.types.Operator):
    ...
    bl_label = "Build Advanced Crane Camera Rig"
    bl_options = {'REGISTER', 'UNDO'}
...
def add_dolly_button(self, context):
    self.layout.operator(
        ...
        text="Advanced Dolly Camera Rig",
        icon='CAMERA_DATA')
...
def add_crane_button(self, context):
    self.layout.operator(
        ...
        text="Advanced Crane Camera Rig",
        icon='CAMERA_DATA')
